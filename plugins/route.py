...
<body>
    <!-- Main Content -->
    <div class="container">
        <div class="team-spy">Warrior Video Player</div>
        <div class="bot-status">⚡ Site is Live Contact If Site or Video player Not Working ⚡</div>

        <div class="actions">
            <a href="https://t.me/WarriorUnitsBots" class="btn">Join Us</a>
            <a href="https://telegram.me/oo7jatji" class="btn">Contact Us</a>
        </div>
    </div>
</body>
</html>
